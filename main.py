...
class BackPack:
    ...
    def ajouter_item(self, quantite, nom):
        ...
        if len(self.liste_items) == 0:
            ...
            if self.item in self.liste_items:
                self.liste_items[self.liste_items.index(self.item)].quantite += quantite
            else:
                self.liste_items.append(self.item)
    ...
    def retirer_item(self, quantite, nom):
        ...
        if len(self.liste_items) == 0:
            ...
            for i in range(len(self.liste_items)):
                if  nom == self.liste_items[i].nom:
                    ...
                    print("L'item n'est pas dans le sac à dos")
            print(self.liste_items)
